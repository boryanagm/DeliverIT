...
namespace Deliverit.Database.Migrations
{
    ...
    [Migration("20210410173336_AddEmailToCustomerAndEmployee")]
    partial class AddEmailToCustomerAndEmployee
    {
            ...
            modelBuilder.Entity("Deliverit.Models.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 487, DateTimeKind.Local).AddTicks(3255),
                            Name = "Barcelona"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 492, DateTimeKind.Local).AddTicks(4360),
                            Name = "Berlin"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 492, DateTimeKind.Local).AddTicks(4429),
                            Name = "Paris"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 492, DateTimeKind.Local).AddTicks(4438),
                            Name = "Vilnius"
                        });
                });
            ...
            modelBuilder.Entity("Deliverit.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 494, DateTimeKind.Local).AddTicks(7689),
                            Name = "Spain"
                        },
                        new
                        {
                            Id = new Guid("afbcad66-1a0a-49f2-9e9c-2c61ded8ae08"),
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 494, DateTimeKind.Local).AddTicks(8790),
                            Name = "Germany"
                        },
                        new
                        {
                            Id = new Guid("72ec653b-aeb1-42fc-bcd1-153f005b1cd4"),
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 494, DateTimeKind.Local).AddTicks(8816),
                            Name = "France"
                        },
                        new
                        {
                            Id = new Guid("c4b3bb07-585f-412b-9f5f-f423928015d4"),
                            CreatedOn = new DateTime(2021, 4, 10, 20, 33, 36, 494, DateTimeKind.Local).AddTicks(8825),
                            Name = "Lithuania"
                        });
                });
