...
namespace Deliverit.Database.Migrations
{
    ...
    [Migration("20210410162046_AllowNullsEntityClass")]
    partial class AllowNullsEntityClass
    {
            ...
            modelBuilder.Entity("Deliverit.Models.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 975, DateTimeKind.Local).AddTicks(8601),
                            Name = "Barcelona"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 978, DateTimeKind.Local).AddTicks(7392),
                            Name = "Berlin"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 978, DateTimeKind.Local).AddTicks(7470),
                            Name = "Paris"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 978, DateTimeKind.Local).AddTicks(7478),
                            Name = "Vilnius"
                        });
                });
            ...
            modelBuilder.Entity("Deliverit.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 980, DateTimeKind.Local).AddTicks(2575),
                            Name = "Spain"
                        },
                        new
                        {
                            Id = new Guid("afbcad66-1a0a-49f2-9e9c-2c61ded8ae08"),
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 980, DateTimeKind.Local).AddTicks(3039),
                            Name = "Germany"
                        },
                        new
                        {
                            Id = new Guid("72ec653b-aeb1-42fc-bcd1-153f005b1cd4"),
                            CreatedOn = new DateTime(2021, 4, 10, 19, 20, 45, 980, DateTimeKind.Local).AddTicks(3065),
                            Name = "France"
                        },
                        new
                        {
