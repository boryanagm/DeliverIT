...
namespace Deliverit.Database.Migrations
{
    ...
    [Migration("20210411113207_SeedEmployees")]
            ...
            modelBuilder.Entity("DeliverIT.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(1487),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(2175),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(2192),
                        ...
                        new
                        {
                            ...
                            CityId = new Guid("e99abf10-63e9-4212-9053-87cb1d80763e"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(2201),
            ...
            modelBuilder.Entity("DeliverIT.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(3964),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(5100),
            ...
            modelBuilder.Entity("DeliverIT.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(5788),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(6880),
            ...
            modelBuilder.Entity("DeliverIT.Models.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(2898)
                        },
                        new
                        {
                            Id = new Guid("988a4201-8c55-42fc-b2a6-e08d1abe6693"),
                            AddressId = new Guid("ac2fee3a-f76e-4d94-aa42-d85b4bb45299"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(3276)
                        });
                });
            ...
            modelBuilder.Entity("Deliverit.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(9345),
                            Name = "Electronics"
                        },
                        new
                        {
                            Id = new Guid("df79ccb6-1f56-41da-9f8f-df2f92a468bb"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(9740),
                            Name = "Clothing"
                        },
                        new
                        {
                            Id = new Guid("7aeb290e-3592-4128-a77a-1a6db6fd81f5"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(9749),
                            Name = "Medical"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Deliverit.Models.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 801, DateTimeKind.Utc).AddTicks(3250),
                            Name = "Barcelona"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 801, DateTimeKind.Utc).AddTicks(4291),
                            Name = "Berlin"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 801, DateTimeKind.Utc).AddTicks(4308),
                            Name = "Paris"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 801, DateTimeKind.Utc).AddTicks(4316),
                            Name = "Vilnius"
                        });
                });
            ...
            modelBuilder.Entity("Deliverit.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(8123),
                            Name = "Spain"
                        },
                        new
                        {
                            Id = new Guid("afbcad66-1a0a-49f2-9e9c-2c61ded8ae08"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(8519),
                            Name = "Germany"
                        },
                        new
                        {
                            Id = new Guid("72ec653b-aeb1-42fc-bcd1-153f005b1cd4"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 802, DateTimeKind.Utc).AddTicks(8527),
                            Name = "France"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Deliverit.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(437),
                            Name = "Preparing"
                        },
                        new
                        {
                            Id = new Guid("858ac364-d94f-414c-bbea-a0f5b8679b3d"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(755),
                            Name = "OnTheWay"
                        },
                        new
                        {
                            Id = new Guid("84568d3c-04df-47c3-9ad8-216b1d664166"),
                            CreatedOn = new DateTime(2021, 4, 11, 11, 32, 6, 803, DateTimeKind.Utc).AddTicks(764),
                            Name = "Completed"
                        },
                        new
                        {
